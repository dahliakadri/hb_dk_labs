...
def show_shopping_cart():
    ...
    for melon_id in session['cart']:
        ...
        qty = int(session['cart'][melon_id])
        price = int(melon_object.price)
        melon_cost = qty * price
        total_cost = total_cost + melon_cost
        melon_object.qty = qty
        melon_object.melon_cost = melon_cost
...
def add_to_cart(melon_id):
    ...
    page and display a confirmation messagecd: 'Melon successfully added to
    cart'."""
